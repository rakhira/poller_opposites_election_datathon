...
consumer_key = os.getenv("9gd6JoLLkvqYPms1HDXglntOi")
consumer_secret = os.getenv("XWG35WsfnuV7hv9uPL0p4VmUgkn7PO7VBKozXXzMI7iMyzGKg7")
access_token = os.getenv("1290462026301673480")
access_token_secret = os.getenv("zpRRy0wJqNaprfYpmOBGmqkgcObCTeRWwKVMJpIcl1nTa")
